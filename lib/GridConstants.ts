...
export class GridConstants {
   ...
   * Minimum longitude
   */
  public static readonly MIN_LON = -180.0;

  /**
   * Maximum longitude
   */
  public static readonly MAX_LON = 180.0;

  /**
   * Minimum latitude
   */
  public static readonly MIN_LAT = -90.0;
   ...
   * Max map zoom level
   */
  public static readonly MAX_MAP_ZOOM_LEVEL = 21;
